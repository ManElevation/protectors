...
protector = {}
protector.mod = "redo"
protector.radius = tonumber(minetest.settings:get("protector_radius")) or 5 -- Steel Protector Radius
protector.radius2 = tonumber(minetest.settings:get("protector_radius2")) or 6 -- Copper Protector Radius
protector.radius3 = tonumber(minetest.settings:get("protector_radius3")) or 8 -- Diamond Protector Radius
protector.radius4 = tonumber(minetest.settings:get("protector_radius4")) or 10 -- Mese Protection Radius
...
protector.can_dig = function(r, pos, digger, onlyowner, infolevel)
	...
	local pos = minetest.find_nodes_in_area(
		...
		{x = pos.x + r, y = pos.y + r, z = pos.z + r},
		{"protector:steelprotect", "protector:protect2", "protector:copperprotect", "protector:diamondprotect", "protector:meseprotect"})
...
minetest.register_node("protector:steelprotect", {
	description = S("Steel Protection Block") .. " (" .. S("USE for area check") .. ")",
	drawtype = "nodebox",
	tiles = {
...
minetest.register_node("protector:meseprotect", {
	...
	tiles = {
		"meseprotector.png",
		"meseprotector.png",
		"meseprotector.png^protector_logo.png"
	},
	sounds = default.node_sound_stone_defaults(),
	groups = {dig_immediate = 2, unbreakable = 1},
	is_ground_content = false,
	...
	on_punch = function(pos, node, puncher)
		...
		minetest.add_entity(pos, "protector:display4")
	end,
...
minetest.register_node("protector:diamondprotect", {
	...
	drawtype = "nodebox",
	tiles = {
		"diamondprotector.png",
		"diamondprotector.png",
		"diamondprotector.png^protector_logo.png"
	},
	sounds = default.node_sound_stone_defaults(),
	groups = {dig_immediate = 2, unbreakable = 1},
	is_ground_content = false,
	...
	on_punch = function(pos, node, puncher)
		...
		minetest.add_entity(pos, "protector:display3")
	end,
...
minetest.register_node("protector:copperprotect", {
	...
	tiles = {
		"copperprotector.png",
		"copperprotector.png",
		"copperprotector.png^protector_logo.png"
	},
	sounds = default.node_sound_stone_defaults(),
	groups = {dig_immediate = 2, unbreakable = 1},
	is_ground_content = false,
...
-- Diamond Radius
-- display entity shown when protector node is punched
minetest.register_entity("protector:display3", {
	physical = false,
	collisionbox = {0, 0, 0, 0, 0, 0},
	visual = "wielditem",
	-- wielditem seems to be scaled to 1.5 times original node size
	visual_size = {x = 1.0 / 1.5, y = 1.0 / 1.5},
	textures = {"protector:display_node3"},
	timer = 0,
...
local x = protector.radius3
minetest.register_node("protector:display_node3", {
	tiles = {"protector_display.png"},
	use_texture_alpha = true,
	walkable = false,
	drawtype = "nodebox",
...
-- Mese Radius
-- display entity shown when protector node is punched
minetest.register_entity("protector:display4", {
	physical = false,
	collisionbox = {0, 0, 0, 0, 0, 0},
	visual = "wielditem",
	-- wielditem seems to be scaled to 1.5 times original node size
	visual_size = {x = 1.0 / 1.5, y = 1.0 / 1.5},
	textures = {"protector:display_node4"},
	timer = 0,
...
local x = protector.radius4
minetest.register_node("protector:display_node4", {
	tiles = {"protector_display.png"},
	use_texture_alpha = true,
	walkable = false,
	drawtype = "nodebox",
...
if minetest.get_modpath("mesecons_mvps") then
	mesecon.register_mvps_stopper("protector:steelprotect")
	mesecon.register_mvps_stopper("protector:protect2")
	mesecon.register_mvps_stopper("protector:copperprotect")
	mesecon.register_mvps_stopper("protector:diamondprotect")
	mesecon.register_mvps_stopper("protector:meseprotect")
